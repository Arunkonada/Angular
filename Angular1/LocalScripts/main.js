...
/// <reference path="E:\study-stuff\Angular-Demos\Angular1\Angular1\Scripts/angular-route.min.js" />

var mainModule = angular.module("mainApp", ["ngRoute"]);
mainModule.controller('crudController',function($scope) {
            var data = [
                {
...
mainModule.controller('dialController', function ($scope) {
...
mainModule.controller('angController', function () {
